...
* Added lossy `jpegrecompress` worker using `jpeg-recompress`, enabled [#65](https://github.com/toy/image_optim/issues/65) [@wjordan](https://github.com/wjordan) [@toy](https://github.com/toy)
